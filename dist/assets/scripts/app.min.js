...
app.productCard = {
  ...
  init: function init() {
    ...
    $(".scroll-link").on('click', function () {
      ...
      $(".product-card__tab[href=\"#".concat(scrollLinkDataAttr, "\"]")).addClass('tab--active');
      $("#".concat(scrollLinkDataAttr)).addClass('tabs-content--active');
      $("html, body").animate({
...
app.productDetails = {
  ...
  init: function init() {
    ...
    $('.product-details__hide-btn').on('click', function () {
      ...
      var $productDetailsContent = $productDetailsHideBtn.closest('.product-details__section').find('.product-details__list');
...
(function ($) {
  $(document).ready(function () {
    ...
    app.validation.init();
    app.burger.init(); //app.searchForm.init();
    ...
    app.asideFilters.init(); //app.catalogFilters.init();
    //app.sortFilter.init();
    //app.sizeFilter.init();
    ...
    app.popup.init(); //app.regionPopup.init();
    ...
    app.pageup.init();
    app.auth.init();
    app.pickupFilters.init(); //app.productSizes.init();
