...
app.blog = {
  ...
  description: 'your script description',
  init: function init() {
    var blogSlider = new Swiper('.blog-text__slider', {
      loop: true,
      spaceBetween: 27,
      speed: 1000,
      lazy: true,
...
app.productPopup = {
  ...
  description: 'your script description',
  init: function init() {
    var productPopupSlider = new Swiper('.product-popup__slider', {
      loop: true,
      slidesPerView: 1,
      speed: 1000,
      pagination: {
...
app.sliderSections = {
  ...
  description: 'your script description',
  init: function init() {
    var catalogSlider = new Swiper('.popular-goods-slider', {
      loop: true,
      slidesPerView: 1,
      spaceBetween: 20,
      speed: 1000,
...
app.validation = {
  ...
  init: function init() {
    ...
    validateForms('#discount-popup form'); // форма подписки в футере
...
$(document).ready(function () {
  ...
  app.feedback.init();
  app.pageup.init();
  app.auth.init(); //app.productSizes.init();
