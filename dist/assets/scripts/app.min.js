...
app.catalogFilters = {
  ...
  init: function init() {
    $('.catalog-filter__title').on('click', function () {
      var $catalogFiltersItemTitle = $(this);
      var $catalogFiltersItem = $catalogFiltersItemTitle.parent();
      var $catalogFiltersItemDrop = $catalogFiltersItem.find('.catalog-filter__drop');
      var $catalogFiltersItemNotActive = $catalogFiltersItem.siblings();
      var $catalogFiltersItemTitleNotActive = $catalogFiltersItemNotActive.find('.catalog-filter__title');
      var $catalogFiltersItemDropNotActive = $catalogFiltersItemNotActive.find('.catalog-filter__drop');
    ...
    $(document).on('mouseup', function (e) {
      var $catalogFiltersItemTitleActive = $('.catalog-filter__title.active');
      var $catalogFilter = $catalogFiltersItemTitleActive.closest('.catalog-filters__item');
      var $catalogFiltersItemDrop = $catalogFilter.find('.catalog-filter__drop');
    ...
    $('.catalog-filters__item--material input[type="checkbox"], .catalog-filters__item--color input[type="checkbox"], .catalog-filters__item--brand input[type="checkbox"], .catalog-filters__item--details input[type="checkbox"], .catalog-filters__item--style input[type="checkbox"], .catalog-filters__item--decor input[type="checkbox"]').on('click', function () {
      var $checkbox = $(this);
      var className = $checkbox.closest('.catalog-filters__item').attr('class').split(' ').join('.');
      var checkedItems = $(".".concat(className, " input:checkbox:checked")).length;
      var $catalogFiltersItemTitle = $checkbox.closest('.catalog-filters__item').find('.catalog-filter__title');
    ...
    $('.catalog-filters__reset-btn').on('click', function () {
      ...
      var $catalogFiltersItemTitle = $catalogFilters.find('.catalog-filter__title');
      var $catalogFiltersItemDrop = $catalogFilters.find('.catalog-filter__drop');
    ...
    $('.catalog-drop-filter__btn[type=reset]').on('click', function () {
      ...
      var $catalogFiltersItemTitle = $catalogDropFilterResetBtn.closest('.catalog-filters__item').find('.catalog-filter__title');
      var $filterOutput = $catalogFiltersItemTitle.find('.filter-output');
      $catalogFiltersItemTitle.css('font-weight', '400');
      $filterOutput.text('');
    ...
    $('.catalog-filter__title').on('click', function () {
      if ($(window).width() < 1025) {
        var $catalogFiltersItemTitle = $(this);
        var $catalogFiltersItemTitleText = $catalogFiltersItemTitle.children().first().text();
        var $catalogFiltersItem = $catalogFiltersItemTitle.closest('.catalog-filters__item');
        var $catalogFiltersItemNotActive = $catalogFiltersItem.siblings();
        var $catalogFiltersItemDrop = $catalogFiltersItem.find('.catalog-filter__drop');
        var $catalogFilters = $catalogFiltersItem.closest('.catalog-filters');
    ...
    $('.catalog-filters__item--sort .catalog-drop-filter__item').on('click', function () {
      ...
      var $catalogFiltersItemTitle = $catalogDropFilterItem.closest('.catalog-filters__item').find('.catalog-filter__title');
      $catalogFiltersItemTitle.css('font-weight', '600');
    ...
    $('input[name=price_from]').on('input change', function () {
      var $input = $(this);
      var inputVal = $input.val();
      var $catalogFiltersItemTitle = $input.closest('.catalog-filters__item').find('.catalog-filter__title');
...
app.productDetails = {
  ...
  init: function init() {
    ...
    $('.product-details__hide-btn').on('click', function () {
      ...
      var $productDetailsContent = $productDetailsHideBtn.closest('.product-details__section-title').next();
